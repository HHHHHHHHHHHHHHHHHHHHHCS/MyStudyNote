...
终于在过年前写完了. UE 这类教程写起来确实又长又难.

2026 年才过去两个月, AI 的进步已经非常快了. 想起一个段子: 以前一个 UI 组 100 人每天做 100 个 UI, 现在用了 AI, 10 个人每天先生成 1000 个 UI, 再筛选和细修后依然要交付 100 个甚至更多. 人少了, 工作量不一定少. to be or not to be, this is a question. 
