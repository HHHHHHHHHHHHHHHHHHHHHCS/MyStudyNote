...
VSM, 方差阴影贴图. 需要理解方差和切比雪夫不等式. 可以参考GPU Gems3 [文章地址][18]
...
I have a esm, I have a vsm, 嗯哼 evsm. 参考的影子传说 [文章地址][19] 和 martincap的EVSM [文章地址][20]. martincap里面还有demo和代码.
...
[21]:https://developer.download.nvidia.com/presentations/2008/GDC/GDC08_SoftShadowMapping.pdf